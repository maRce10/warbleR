...
![warbleR logo](/home/m/Documents/WarbleR package/current version/warbleR/vignettes/Logo Warble-azul small margin.jpg)
...
![warbleR workflow diagram, make it 700 pxl width](/home/m/Documents/WarbleR package/current version/warbleR/vignettes/warbleR workflow english small.jpg)
...
![autodetec image example, make it 700 pxls width](/home/m/Documents/WarbleR package/current version/warbleR/vignettes/Phaethornis-longirostris-154161-1-autodetec.ls-th10-env.abs-bp1.10-msmo300.90-midu0.05-mxdu0.5-pw1-p1.jpg)
...
![autodetec image example, make it 700 pxls width](/home/m/Documents/WarbleR package/current version/warbleR/vignettes/Phaethornis-longirostris-154161-1-autodetec.ls-th15-env.abs-bp3.9-msmo900.90-midu0.09-mxdu0.22-pw1-p1.jpg)
...
#do not show this 
params <- read.csv("/home/m/Documents/WarbleR package/current version/warbleR/vignettes/acoustic parameters.csv")
...
Now lets remove parameters derived from fundamental frequency (based on trackfreqs results)
```{r, eval=T}
...
![song types, make it 700 pxl width](/home/m/Documents/WarbleR package/current version/warbleR/vignettes/song types spectros.jpg)
