...
<br>
This vignette can be run without an advanced understanding of R, as long as you know how to run code and distinguish code from comments. However, knowing more about the following will greatly aid your understanding:
