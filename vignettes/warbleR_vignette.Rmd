...
library(warbleR)
library(knitr)
# setwd("/home/m/Dropbox/Projects/warbleR package/vignette files")
```
...
file.copy(from = file.path("/home/m/Documents/Biblioteca de cantos/Trochilidae/XC/wavs",fn),to=file.path("/home/m/Dropbox/Projects/warbleR package/vignette files",fn),overwrite = T)
