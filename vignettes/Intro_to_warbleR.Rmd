...
author: 
- <center><a href="https://marceloarayasalas.weebly.com">Marcelo Araya-Salas, PhD</a> & <a href="https://smith-vidaurre.com/">Grace Smith-Vidaurre</a> </center>
...
```{r extn_sel_7/2, echo=FALSE, results = "asis"}
...
```{r extn_sel_8.1, echo=FALSE, results = "asis"}
...
The `querxc()` function allows you to search and download sounds from the free access database [Xeno-Canto](https://www.xeno-canto.org/). You can also convert .mp3 files to .wav, change the sampling rate of the files and correct corrupt files, among other functions.
