...
- Production of images in the working directory with spectrograms that allow you to organize data and verify acoustic analyzes </font>
...
This format is also used by the **NatureSounds** package, which contains an extended selection table with long-billed hermit hummingbirds vocalizations from 10 different song types:
