...
#' 
#' \code{wav_dur} measures the duration of sound files in '.wav' format
#' @usage wav_dur(files = NULL, path = NULL)
...
wav_dur <- function(files = NULL, path = NULL) { 
  
  #### set arguments from options
  # get function arguments
  argms <- methods::formalArgs(wav_dur)
...
##############################################################################################################
#' alternative name for \code{\link{wav_dur}}
#'
#' @keywords internal
#' @details see \code{\link{wav_dur}} for documentation. \code{\link{wavdur}} will be deprecated in future versions.
#' @export
