...
#' 
#' \code{est_rename_waves} rename wave objects and associated metadata in extended selection tables
#' @export est_rename_waves
#' @usage est_rename_waves(X, new.sound.files, new.selec = NULL)
...
#' 
#' # rename sound files
#' Y <- est_rename_waves(X = lbh.est, new.sound.files = nsf)
#' }
#' 
#' @references {
...
est_rename_waves <- function(X, new.sound.files, new.selec = NULL){
...
##############################################################################################################
#' alternative name for \code{\link{est_rename_waves}}
#'
#' @keywords internal
#' @details see \code{\link{est_rename_waves}} for documentation. \code{\link{rename_waves_est}} will be deprecated in future versions.
#' @export

rename_waves_est <- est_rename_waves