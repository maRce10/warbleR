...
#' than the observed value. Solo singing at the beggining and end is not taken into account. The function runs one test 
#' for each singing event in the input data frame.  
#' @examples
#' \dontrun{
