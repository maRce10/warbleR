...
#' @param X Data frame with generated by \code{\link{find_annotations}} when \code{warbler.format = TRUE}. If supplied the recordings listed in the data frame ('sound.files" column)
#' will be download using the 'recording_url' column information (\code{download} argument is automatically set to \code{TRUE}). This can be used to select
