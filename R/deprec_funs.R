...
sp.en.ts <- entropy_ts <- function(...) write(file = "", x = "This function has been deprecated. Spectral entropy contours can be calculated using `freq_ts`")
...
xcorr.graph <- function(...) write(file = "", x = "This function has been deprecated as it was not compatible with changes to improve performance in 'xcorr()' (use corrplot package instead)")

manualoc <- manual_loc <- function(...) write(file = "", x = "This function has been deprecated. Try Raven Software (Cornell Lab of Ornithology) or Audacity to manually annotate. The Rraven package (imp_raven) can be used for importing Raven annotations: try `install.packages('Rraven')`")
