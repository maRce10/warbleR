...
##############################################################################################################
#' alternative name for \code{\link{compare_methods}}
#'
#' @keywords internal
#' @details see \code{\link{compare_methods}} for documentation. \code{\link{compare.methods}} will be deprecated in future versions.
#' @export

compare.methods <- compare_methods
