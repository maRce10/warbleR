#' Splits sound files
#' 
#' \code{wav_split} splits sound files in shorter segments
#' @usage wav_split(path = NULL, sgmt.dur = 10, sgmts = NULL, files = NULL,
...
#' wav_split(sgmt.dur = 1, path = tempdir())
#' 
#' # Check this folder
#' tempdir()
#' }
...
wav_split <- function(path = NULL, sgmt.dur = 10, sgmts = NULL, files = NULL, parallel = 1, pb = TRUE, only.sels  = FALSE, X = NULL){
  
  #### set arguments from options
  # get function arguments
  argms <- methods::formalArgs(wav_split)
...
##############################################################################################################
#' alternative name for \code{\link{wav_split}}
#'
#' @keywords internal
#' @details see \code{\link{wav_split}} for documentation. \code{\link{split_wavs}} will be deprecated in future versions.
#' @export

split_wavs <- wav_split
