...
> Conduct](https://marce10.github.io/warbleR/blob/master/CODE_OF_CONDUCT.md).
> By participating, you are expected to uphold this code. Please report
> unacceptable behavior to <https://github.com/maRce10/warbleR/issues/>.

## I Have a Question

If you want to ask a question, we assume that you have read the
available [Documentation](https://marce10.github.io/warbleR/articles/).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/maRce10/warbleR/issues/) that might help
...
- Open an
  [https://github.com/maRce10/warbleR/issues/](https://github.com/maRce10/warbleR/issues/new).
...
- Determine if your bug is really a bug and not an error on your side
  ...
  [documentation](https://marce10.github.io/warbleR/articles/). If you
...
- Open an [Issue](https://github.com/maRce10/warbleR/issues/new). (Since
...
- Make sure that you are using the latest version.
- Read the [documentation](https://marce10.github.io/warbleR/articles/)
  carefully and find out if the functionality is already covered, maybe
  by an individual configuration.
- Perform a [search](https://github.com/maRce10/warbleR/issues) to see
...
issues](https://github.com/maRce10/warbleR/issues/).
